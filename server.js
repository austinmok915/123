...
const server = http.createServer((req,res) => {
	...
	switch(parsedURL.pathname) {
		case '/':
			...
			res.write('	 <p>');
			res.write(`	 <input name="logid" class="w3-input" type="text" style="width:40%" required="">`);
			res.write('	 <label class="w3-label w3-validate">Name</label></p>');
			res.write('	  <p>');
			res.write(`	  <input name="password" class="w3-input" type="password" style="width:40%">`);
            ...
            res.write('         <p>');
            res.write(`         <input name="regid" class="w3-input" type="text" style="width:40%" required="">`);
            res.write('         <label class="w3-label w3-validate">Name</label></p>');
            res.write('         <p>');
            res.write(`         <input name="repassword" class="w3-input" type="password" style="width:40%">`);
            res.write('         <label class="w3-label w3-validate">Password</label></p>');
            res.write('         <p>');
            res.write('         <p>');
            res.write(`         <input name="confirmpassword" class="w3-input" type="password" style="width:40%">`);
